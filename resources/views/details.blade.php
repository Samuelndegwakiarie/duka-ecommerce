                            ...
                            <div class="product-details">
                                ...
                                <div class="main-price">
                                    ...
                                    <div class="listing-content">
                                        <span class="font-light">{{$rproducts->category}}</span>
                                        <p class="font-light">{{$rproducts->short_description}}</p>
                                    </div>
                                    <h3 class="theme-color">@if($rproducts->sale_price) {{$product->sale_price}} @else {{$rproduct->regular_price}}  @endif</h3>
